...
/**
 * This is the item provider adapter for a {@link Json.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 JsonPackage.Literals.LINK__SOURCE_NODE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetNodePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_targetNode_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_targetNode_feature", "_UI_Link_type"),
				 JsonPackage.Literals.LINK__TARGET_NODE,
				 true,
				 false,
				 true,
				 null,

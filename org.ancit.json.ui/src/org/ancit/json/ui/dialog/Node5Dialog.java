...
public class Node5Dialog extends Dialog {
	 ...
	 * @param Node5
	 */
	public Node5Dialog(Shell parentShell, Node5 Node5) {
		super(parentShell);
		this.node5 = Node5;
	}
	...
	protected Control createDialogArea(Composite parent) {
		...
		if (node5.getName() != null) {
			text.setText(node5.getName());
		}
		text.addModifyListener(e -> {

			if (text != null) {
				node5.setName(text.getText());
			}
		...
		if (node5.getType().getLiteral() != null) {
			combo.setText(node5.getType().getLiteral());
		}
		...
		if (node5.getDate() != null) {
			dateTime.setData(node5.getDate());
		}

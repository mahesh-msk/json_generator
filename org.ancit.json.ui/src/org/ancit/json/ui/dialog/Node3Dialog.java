...
public class Node3Dialog extends Dialog {
	 ...
	 * @param node3
	 */
	public Node3Dialog(Shell parentShell, Node3 node3) {
		super(parentShell);
		this.node3 = node3;
	...
	protected Control createDialogArea(Composite parent) {
		...
		if (node3.getName() != null) {
			text.setText(node3.getName());
		}
		text.addModifyListener(e -> {

			if (text != null) {
				node3.setName(text.getText());
			}
		...
		if (node3.getType().getLiteral() != null) {
			combo.setText(node3.getType().getLiteral());
		}
		...
		if (node3.getDate() != null) {
			dateTime.setData(node3.getDate());
		}
